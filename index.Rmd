...
Dado que las fechas en los CSV están en formato DD/MM/YYYY debemos de convertir a YYYY-MM-DD para su correcta manipulación con R studio. \## Cargamos librerías a usa
...
save(df_datos_completos, file = "_data/datos_completos.RData")
