...
```{r}
 selectInput("rutaOpcion", label = h3("Listado de rutas"), 
    choices = list(
      "La Paz → Oruro → Potosí → Sucre" = 1, 
      "Santa Cruz → Trinidad → Riberalta → Cobija" = 2, 
      "3" = 3, 
      "4" = 4, 
      "5" = 5), 
    selected = 1)
...
renderText({
  paste("Seleccionaste la opción:", input$rutaOpcion)
})
